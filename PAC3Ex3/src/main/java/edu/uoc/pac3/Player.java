...
public class Player {
    ...
    public Player(String name, int level, LocalDate creationDate, int experience, int gold, double healthRegenPerSec, double criticalPct, double dodgePct, String honorTitle, PlayerRace race) {
        setName(name);
        setLevel(level);
    ...
    public Player(String name, int level, LocalDate creationDate, int experience, int gold, double healthRegenPerSec, double criticalPct, double dodgePct, String honorTitle, PlayerRace race, String petName, int petLevel, LocalDate petBirthdate, int petLoyalty, int petStamina, boolean petIsAggressive) {
        this(name, level, creationDate, experience, gold, healthRegenPerSec, criticalPct, dodgePct, honorTitle, race);
    ...
    /**
     * Retrieves the current race of the player.
     * This method returns the player's race, which can provide insights into
     * the player's abilities, traits, or any special attributes associated with their race.
     *
     * @return PlayerRace the current race of the player
     */
    ...
    /**
     * Sets the player's race to a specified value.
     * This method updates the player's race, which is crucial for ensuring the player
     * is associated with a valid race at all times. If the specified race is null,
     * it throws an IllegalArgumentException to prevent the player from having a null race.
     *
     * @param playerRace the new race to be set for the player, cannot be null
     * @throws IllegalArgumentException if the provided race is null, with a message specifying that
     *                                  the player race cannot be null.
     */
